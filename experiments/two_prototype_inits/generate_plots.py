...
def main():
    ...
    data1 = np.array(statistics['yrand_sbm_rand']).flatten()
    data2 = np.array(statistics['yrand_sbm_dist']).flatten()
    data3 = np.array(statistics['yrand_sbm_spectral']).flatten()
    data4 = np.array(statistics['yrand_dist_spectral']).flatten()
    data5 = np.array(statistics['yrand_spectral_spectral']).flatten()
    data6 = np.array(statistics['yrand_dist_dist']).flatten()
    ...
    data1 = np.array(statistics['elbo_sbm_rand']).flatten()
    data2 = np.array(statistics['elbo_sbm_dist']).flatten()
    data3 = np.array(statistics['elbo_sbm_spectral']).flatten()
    data4 = np.array(statistics['elbo_dist_spectral']).flatten()
    data5 = np.array(statistics['elbo_spectral_spectral']).flatten()
    data6 = np.array(statistics['elbo_dist_dist']).flatten()
