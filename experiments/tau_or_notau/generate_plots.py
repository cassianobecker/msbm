...
def main():
    ...
    data1 = np.array(statistics['yrand_tru_tru']).flatten()
    ...
    plt.boxplot(data)
    plt.xticks(range(1,5),['tru;tru', 'noisy;tru', 'tru;noisy', 'dist;noisy'], fontsize=8)
    ...
    data1 = np.array(statistics['elbo_tru_tru']).flatten()
